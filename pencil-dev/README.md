...
> 최종 업데이트: 2026-06-08 (공식 문서 전수조사 완료)
...
| 01 | [설치 및 설정](./01-installation.md) | VS Code, Cursor, Antigravity, Windsurf, 데스크톱, Pencil CLI, Claude Code CLI 설치 |
...
| # | 문서 | 설명 |
| --- | --- | --- |
| 03 | [.pen 파일 기본](./03-pen-files.md) | 파일 포맷, Document 구조, 임포트, 테마, 변수 정의, Overrides/Nesting |
...
| 09 | [그래픽과 효과](./09-graphics-effects.md) | Fill 5종, Stroke, Effect 3종, Mesh Gradient bezier, Shader uniforms, SVG Path, 이미지, 아이콘 |
...
| 12 | [디자인 시스템 구성](./12-design-system.md) | 컴포넌트/슬롯 기본, Sidebar, Card, Table, Tabs, Dropdown, Pagination 조합 패턴 |
