...
| 02 | [API 레퍼런스](./02-api-reference.md) | 요청/응답 스키마, 파라미터, 타입 정의, Reasoning, Verbosity |
...
| 10 | [웹 검색](./10-web-search.md) | 웹 검색 엔진, 네이티브/Exa 검색, 서버 툴 방식, 가격 |
...
| 15 | [개인정보 및 데이터 처리](./15-privacy.md) | 데이터 수집, ZDR, 데이터 정책, EU 레지던시 |
